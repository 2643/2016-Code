...
//        chooser.addObject("My Auto", new MyAutoCommand());
    ...
    public void teleopPeriodic() {
    	   ...
    	   double zPosition = driveStick.getZ();
    	    ...
    	    frDriveTrainWheel.set(zPosition);
    	    brDriveTrainWheel.set(zPosition);
    	    flDriveTrainWheel.set(yPosition);
    	    blDriveTrainWheel.set(yPosition);
