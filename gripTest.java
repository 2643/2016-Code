...
//        chooser.addObject("My Auto", new MyAutoCommand());
        ...
        camera = new AxisCamera("10.26.43.11");
        SmartDashboard.putData("Auto mode", chooser);
		...
		double MAGIC_DISTANCE_NUMBER = 1.08;
			...
			switch(state )
    		{
    			case 0:
    	    		...
    	    		width =  widths[temp];
    	    		double distance = 16*(640/width) * MAGIC_DISTANCE_NUMBER;
    			...
    			case 1:
    				...
    				//if you're past the middle when you started on the right or if you're past the middle when you started on the left stop spinning
    				if((position && centerX < 240) || (!position && centerX > 240))
    				{
    					//stop spinning
    					state = 0;
    				}
